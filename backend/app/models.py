...
class Tenant(Base):
    ...
    kennitala: Mapped[Optional[str]] = mapped_column(String, nullable=True)
    address: Mapped[Optional[str]] = mapped_column(String, nullable=True)
    ceo: Mapped[Optional[str]] = mapped_column(String, nullable=True)
...
class User(Base):
    ...
    custom_title = Column(String, nullable=True) # Optional visual job title (e.g. CEO, CFO, Master Electrician)
...
class OfferLineItem(Base):
    ...
    is_provisional: Mapped[bool] = mapped_column(Boolean, default=False)  # Áætluð vinna (Provisional measurement)
