...
class TaskBase(BaseModel):
    title: str; description: Optional[str] = None; status: Optional[str] = "To Do"; priority: Optional[str] = "Medium"
...
class TaskUpdate(BaseModel):
    ...
    priority: Optional[str] = None; due_date: Optional[datetime] = None; project_id: Optional[int] = None; assignee_id: Optional[int] = None
...
# Update Forward Refs if needed (usually automatic in Pydantic v2)
