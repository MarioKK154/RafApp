...
class TaskReadBasic(BaseModel):
    ...
    class Config(OrmConfig): # Corrected multi-line formatting
        pass
...
class TaskCommentReadBasic(BaseModel):
    ...
    created_at: datetime
    author_id: int
    author: Optional[UserReadBasic] = None # Added for consistency
...
class TaskPhotoReadBasic(BaseModel):
    id: int
    filename: str
    description: Optional[str] = None # Added for consistency
    uploaded_at: datetime
    uploader_id: int # Added uploader_id for consistency
    uploader: Optional[UserReadBasic] = None # Added for consistency
...
class UserRead(UserBase):
    ...
    assigned_projects: List[ProjectReadBasic] = [] # Ensure this is present
...
class UserChangePassword(BaseModel):
    ...
    new_password: str = Field(..., min_length=8) # Enforce min length for new password
...
class ProjectUpdate(ProjectBase):
    ...
    start_date: Optional[datetime] = None
    end_date: Optional[datetime] = None
    project_manager_id: Optional[int] = None # Allow updating PM
...
class ProjectRead(ProjectBase):
    ...
    created_at: Optional[datetime] = None
    updated_at: Optional[datetime] = None
    # project_manager_id is inherited
...
class TaskRead(TaskBase):
    ...
    created_at: Optional[datetime] = None
    updated_at: Optional[datetime] = None
    # comments: List[TaskCommentReadBasic] = [] # Example for nesting
    # photos: List[TaskPhotoReadBasic] = []   # Example for nesting
