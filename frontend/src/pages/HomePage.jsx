...
function HomePage() {
    ...
    const handleConfirmClockOut = async (e) => {
        ...
        if (!clockOutNotes.trim()) {
            toast.warning(
                t('work_description_required', {
                    defaultValue: 'Please describe the work performed before clocking out.',
                })
            );
            return;
        }
    ...
    return (
        <div className="container mx-auto p-4 md:p-8 max-w-7xl animate-in fade-in duration-500">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
                {/* Managed Projects List - with background container */}
                <div className="lg:col-span-2">
                    <div className="bg-white/95 dark:bg-gray-800/95 backdrop-blur-md rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm p-6">
