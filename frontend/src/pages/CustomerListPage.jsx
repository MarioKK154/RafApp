    ...
    return (
        <div className="container mx-auto p-4 md:p-8 max-w-[1600px] animate-in fade-in duration-500">
            <PageHeader
                ...
                subtitle={t('customer_directory_subtitle', { defaultValue: 'Client Accounts, Contacts & Billing Information' })}
                stats={[
                    { label: `${customers.length} ${t('clients', { defaultValue: 'Clients' })}`, icon: <UserGroupIcon className="h-4 w-4 text-indigo-300" /> },
                ]}
                actions={
                    <button
