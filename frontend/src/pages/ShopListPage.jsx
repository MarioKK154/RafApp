    ...
    return (
        <div className="container mx-auto p-4 md:p-8 max-w-[1600px] animate-in fade-in duration-500">
            <PageHeader
                ...
                title={t('vendors', { defaultValue: 'Wholesale Suppliers & Stores' })}
                subtitle={t('vendors_subtitle', { defaultValue: 'Electrical Suppliers, Stores & Discount Agreements' })}
                stats={[
                    { label: `${shops.length} ${t('vendors', { defaultValue: 'Suppliers' })}`, dotColor: 'bg-green-400 animate-pulse' },
                ]}
                actions={
                    canManageShops && (
                        <button
                        ...
                        >
                            <PlusIcon className="h-5 w-5" /> {t('add_vendor', { defaultValue: '+ Register Vendor' })}
                        </button>
                    )
                }
            />
