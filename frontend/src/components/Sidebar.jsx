                        ...
                        >
                            ...
                            {!isCollapsed && (
                                <div className="flex items-center justify-between flex-1 ml-1">
                                    <span>{i18n.language?.toLowerCase().startsWith('en') ? 'Íslenska' : 'English'}</span>
                                    <span
                                    ...
                                    >
                                        <FlagIcon lang={i18n.language?.toLowerCase().startsWith('en') ? 'is' : 'en'} className="w-3 h-2 rounded-[1px] shadow-2xs" />
                                        {i18n.language?.toLowerCase().startsWith('en') ? 'IS' : 'EN'}
                                    </span>
                                </div>
                            )}
                        </button>
