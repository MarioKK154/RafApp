...
const InvoiceApprovalQueue = () => {
    ...
    const getSupplierBadgeStyle = (supplier) => {
        ...
        if (s.includes('rónning') || s.includes('ronning')) return 'bg-red-500/10 text-red-600 dark:text-red-400 border-red-500/20';
        if (s.includes('ískraft') || s.includes('iskraft')) return 'bg-blue-500/10 text-blue-600 dark:text-blue-400 border-blue-500/20';
